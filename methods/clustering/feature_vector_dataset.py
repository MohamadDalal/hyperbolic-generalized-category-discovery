...
class FeatureVectorDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        if isinstance(self.base_dataset, MergedDataset):
            ...
            return feature_vector, label, uq_idx, 1


    def __len__(self):
        return len(self.base_dataset)
    
class FeatureVectorDataset_WithFileNames(FeatureVectorDataset):
    ...
    def __init__(self, base_dataset, feature_root):
        ...
        if isinstance(self.base_dataset, MergedDataset) or isinstance(self.base_dataset, MergedDataset_WithFileNames):
            self.base_dataset.labelled_dataset.target_transform = None
            self.base_dataset.unlabelled_dataset.target_transform = None
    ...
    def __getitem__(self, item):
        ...
        if isinstance(self.base_dataset, MergedDataset) or isinstance(self.base_dataset, MergedDataset_WithFileNames):
            ...
            # Get meta info for this instance
            _, label, uq_idx, mask_lab, filename = self.base_dataset[item]
            ...
            return feature_vector, label, uq_idx, mask_lab[0], filename

        else:

            # Get meta info for this instance
            _, label, uq_idx, filename = self.base_dataset[item]
            ...
            return feature_vector, label, uq_idx, 1, filename