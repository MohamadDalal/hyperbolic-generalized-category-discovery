...
#SBATCH --output="logs/GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-No-Dist.log"
#SBATCH --job-name="GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-No-Dist"
...
outfile="logs/GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-No-Dist.out"
