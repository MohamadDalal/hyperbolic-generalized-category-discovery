...
#SBATCH --output="logs/GCD-Test-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2.log"
#SBATCH --job-name="GCD-Test-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2"
...
outfile="logs/GCD-Test-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2.out"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} -m methods.test_outputs.test_outputs --dataset_name scars --warmup_model_exp_id 'Hyperbolic-Angle-SGD-HCD-DINOv2' \
