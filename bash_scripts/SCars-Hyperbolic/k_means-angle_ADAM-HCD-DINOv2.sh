...
#SBATCH --output="logs/GCD-KMeans-SCars-Hyperbolic-Angle-ADAM-HCD-DINOv2.log"
#SBATCH --job-name="GCD-KMeans-SCars-Hyperbolic-Angle-ADAM-HCD-DINOv2"
...
outfile="logs/GCD-KMeans-SCars-Hyperbolic-Angle-ADAM-HCD-DINOv2.out"
