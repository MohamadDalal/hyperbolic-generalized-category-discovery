...
#SBATCH --output="logs/GCD-KMeans-SCars-Hyperbolic-HCD-angle-only-H.log"
#SBATCH --job-name="GCD-KMeans-SCars-Hyperbolic-HCD-angle-only-H"
...
outfile="logs/GCD-KMeans-SCars-Hyperbolic-HCD-angle-only-H.out"
