...
#SBATCH --output="logs/GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-65536.log"
#SBATCH --job-name="GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-65536"
...
outfile="logs/GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-65536.out"
