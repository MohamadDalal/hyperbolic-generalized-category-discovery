...
#SBATCH --output="logs/GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-64.log"
#SBATCH --job-name="GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-64"
...
outfile="logs/GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-64.out"
