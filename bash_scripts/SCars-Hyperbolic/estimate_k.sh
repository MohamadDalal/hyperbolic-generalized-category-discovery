...
#SBATCH --output="logs/GCD-Estimate-SCars-Hyperbolic.log"
#SBATCH --job-name="GCD-Estimate-SCars-Hyperbolic"
...
outfile="logs/GCD-Estimate-SCars-Hyperbolic.out"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} -m methods.estimate_k.estimate_k --max_classes 1000 --dataset_name scars --search_mode other --warmup_model_exp_id 'Hyperbolic_best' --hyperbolic 'True'
