...
#SBATCH --output="logs/GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-32.log"
#SBATCH --job-name="GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-32"
...
outfile="logs/GCD-KMeans-SCars-Hyperbolic-Angle-SGD-HCD-DINOv2-32.out"
