...
#SBATCH --output="logs/GCD-SCars-Hyperbolic-Freeze-Curvature-Freeze_Alpha.log"
#SBATCH --job-name="GCD-SCars-Hyperbolic-Freeze-Curvature-Freeze_Alpha"
...
outfile="logs/GCD-SCars-Hyperbolic-Freeze-Curvature-Freeze_Alpha.out"

exp_id="GCD-SCars-Hyperbolic-Freeze-Curvature-Freeze_Alpha"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} -m methods.contrastive_training.contrastive_training \
            ...
            --lr 0.1 \
            --eval_funcs 'v1' 'v2' \
            --exp_id 'SCars-Hyperbolic-Train-Freeze-Curvature-Freeze_Alpha' \
            --hyperbolic 'True' \
            --kmeans 'True' \
            --kmeans_frequency 20 \
            --curvature '1.0' \
