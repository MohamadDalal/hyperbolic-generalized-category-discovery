...
#SBATCH --output="logs/GCD-KMeans-Aircraft-Hyperbolic-HCD-DINOv2.log"
#SBATCH --job-name="GCD-KMeans-Aircraft-Hyperbolic-HCD-DINOv2"
...
outfile="logs/GCD-KMeans-Aircraft-Hyperbolic-HCD-DINOv2.out"
