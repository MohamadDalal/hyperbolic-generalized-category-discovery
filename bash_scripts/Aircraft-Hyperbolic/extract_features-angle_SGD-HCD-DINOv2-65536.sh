...
#SBATCH --output="logs/GCD-Extract-Aircraft-Hyperbolic-Angle-SGD-HCD-DINOv2-65536.log"
#SBATCH --job-name="GCD-Extract-Aircraft-Hyperbolic-Angle-SGD-HCD-DINOv2-65536"
#SBATCH --time=2:00:00
...
outfile="logs/GCD-Extract-Aircraft-Hyperbolic-Angle-SGD-HCD-DINOv2-65536.out"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} -m methods.clustering.extract_features --dataset aircraft --use_best_model 'False' \
 --warmup_model_dir '/ceph/home/student.aau.dk/mdalal20/P10-project/hyperbolic-generalized-category-discovery/osr_novel_categories/metric_learn_gcd/log/Aircraft-Hyperbolic-Angle-SGD-HCD-DINOv2-65536-Train/checkpoints/model_best_loss.pt' \
