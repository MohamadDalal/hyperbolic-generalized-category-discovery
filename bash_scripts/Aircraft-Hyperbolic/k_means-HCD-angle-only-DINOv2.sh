...
#SBATCH --output="logs/GCD-KMeans-Aircraft-Hyperbolic-HCD-angle-only-DINOv2.log"
#SBATCH --job-name="GCD-KMeans-Aircraft-Hyperbolic-HCD-angle-only-DINOv2"
...
outfile="logs/GCD-KMeans-Aircraft-Hyperbolic-HCD-angle-only-DINOv2.out"
