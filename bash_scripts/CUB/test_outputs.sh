...
#SBATCH --output="logs/GCD-Test-CUB.log"
#SBATCH --job-name="GCD-Test-CUB"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} -m methods.test_outputs.test_outputs --dataset_name cub --warmup_model_exp_id '(17.03.2025_|_22.593)'
