...
#SBATCH --output="logs/GCD-KMeans-CIFAR100-Hyperbolic-HCD-DINOv2.log"
#SBATCH --job-name="GCD-KMeans-CIFAR100-Hyperbolic-HCD-DINOv2"
...
outfile="logs/GCD-KMeans-CIFAR100-Hyperbolic-HCD-DINOv2.out"
