...
#SBATCH --output="logs/GCD-Cifar10-Hyperbolic.log"
#SBATCH --job-name="GCD-Cifar10-Hyperbolic"
...
outfile="logs/GCD-Cifar10-Hyperbolic.out"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} -m methods.contrastive_training.contrastive_training \
            ...
            --lr 0.1 \
            --eval_funcs 'v1' 'v2' \
            --exp_id 'Cifar10-Hyperbolic-Train' \
            --hyperbolic 'True' \
            --kmeans 'True' \
            --kmeans_frequency 20 \
            --curvature '1.0' \
            --freeze_curvature 'false' \
            --checkpoint_path '/ceph/home/student.aau.dk/mdalal20/P10-project/hyperbolic-generalized-category-discovery/osr_novel_categories/metric_learn_gcd/log/Cifar10-Hyperbolic-Train/checkpoints/model.pt'
