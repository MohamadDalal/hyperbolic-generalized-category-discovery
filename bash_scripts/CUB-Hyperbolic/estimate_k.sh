...
#SBATCH --output="logs/GCD-Estimate-CUB-Hyperbolic.log"
#SBATCH --job-name="GCD-Estimate-CUB-Hyperbolic"
...
outfile="logs/GCD-Estimate-CUB-Hyperbolic.out"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} -m methods.estimate_k.estimate_k --max_classes 1000 --dataset_name cub --search_mode other --warmup_model_exp_id 'Hyperbolic_best' --hyperbolic 'True'
