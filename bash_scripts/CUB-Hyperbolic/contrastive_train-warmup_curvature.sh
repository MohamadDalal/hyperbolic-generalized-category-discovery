...
#SBATCH --output="logs/GCD-CUB-Hyperbolic-Warmup-Curvature.log"
#SBATCH --job-name="GCD-CUB-Hyperbolic-Warmup-Curvature"
...
outfile="logs/GCD-CUB-Hyperbolic-Warmup-Curvature.out"

exp_id="GCD-CUB-Hyperbolic-Warmup-Curvature"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} -m methods.contrastive_training.contrastive_training \
            ...
            --lr 0.1 \
            --eval_funcs 'v1' 'v2' \
            --exp_id 'CUB-Hyperbolic-Train-Warmup-Curvature' \
            --hyperbolic 'True' \
            --kmeans 'True' \
            --kmeans_frequency 20 \
            --curvature '1.0' \
