...
#SBATCH --output="logs/GCD-KMeans-CUB-Hyperbolic-HCD-angle-only-H.log"
#SBATCH --job-name="GCD-KMeans-CUB-Hyperbolic-HCD-angle-only-H"
...
outfile="logs/GCD-KMeans-CUB-Hyperbolic-HCD-angle-only-H.out"
