...
#SBATCH --output="logs/GCD-KMeans-CUB-Hyperbolic-Angle-ADAM-HCD-DINOv2.log"
#SBATCH --job-name="GCD-KMeans-CUB-Hyperbolic-Angle-ADAM-HCD-DINOv2"
...
outfile="logs/GCD-KMeans-CUB-Hyperbolic-Angle-ADAM-HCD-DINOv2.out"
