...
#SBATCH --output="logs/GCD-KMeans-CUB-Hyperbolic-Angle-SGD-HCD-DINOv2-Learn-Curv.log"
#SBATCH --job-name="GCD-KMeans-CUB-Hyperbolic-Angle-SGD-HCD-DINOv2-Learn-Curv"
...
outfile="logs/GCD-KMeans-CUB-Hyperbolic-Angle-SGD-HCD-DINOv2-Learn-Curv.out"
