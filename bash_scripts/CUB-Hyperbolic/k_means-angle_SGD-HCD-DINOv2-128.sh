...
#SBATCH --output="logs/GCD-KMeans-CUB-Hyperbolic-Angle-SGD-HCD-DINOv2-128.log"
#SBATCH --job-name="GCD-KMeans-CUB-Hyperbolic-Angle-SGD-HCD-DINOv2-128"
...
outfile="logs/GCD-KMeans-CUB-Hyperbolic-Angle-SGD-HCD-DINOv2-128.out"
