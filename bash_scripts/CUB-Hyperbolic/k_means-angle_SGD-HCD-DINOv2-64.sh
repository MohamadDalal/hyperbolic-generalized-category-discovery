...
#SBATCH --output="logs/GCD-KMeans-CUB-Hyperbolic-Angle-SGD-HCD-DINOv2-64.log"
#SBATCH --job-name="GCD-KMeans-CUB-Hyperbolic-Angle-SGD-HCD-DINOv2-64"
...
outfile="logs/GCD-KMeans-CUB-Hyperbolic-Angle-SGD-HCD-DINOv2-64.out"
